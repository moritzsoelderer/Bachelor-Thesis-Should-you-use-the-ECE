...
plt.hist(samples1, bins=math.ceil(sample_size1/10), label="Dist 1", density=True)
plt.hist(samples2, bins=math.ceil(sample_size2/10), label="Dist 2", density=True)
plt.hist(samples3, bins=math.ceil(sample_size3/10), label="Dist 3", density=True)
plt.show()
plt.clf()
