...
#
# Modified by Moritz Soelderer on 28.11.2024 to add output of all estimators, that have been trained,
# in the cv_results after grid search was performed
...
class GridSearchWithEstimatorOutput(BaseSearchCV):
